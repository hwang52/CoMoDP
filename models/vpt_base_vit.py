...
class VPT_ViT(VisionTransformer):
    ...
    def New_CLS_head(self, new_classes): # projection linear
    ...
    def obtain_prompt(self):
        prompt_state_dict = {'head': self.head.state_dict(), 'Prompt_Tokens': self.Prompt_Tokens}
    ...
    def forward_features(self, x): # forward
        ...
        if self.VPT_type == "Deep":
            ...
            for i in range(len(self.blocks)):
                ...
                # if vpt_type==deep --> lastly remove, a genius trick
